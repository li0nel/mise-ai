    ...
    instructions: [
      {
        stepNumber: 1,
        title: "Fry the paste",
        text: "Skim thick cream from the top of the coconut milk. Fry curry paste in the cream over medium heat until fragrant and oil separates, about 5 minutes.",
        timers: [{ duration: "5 min", activity: "fry" }],
      },
      {
        stepNumber: 2,
        title: "Braise the beef",
        text: "Add beef cubes and sear in the paste. Pour in remaining coconut milk, add cinnamon stick and cardamom. Bring to a simmer, cover, and braise for 1 hour.",
        timers: [{ duration: "1 hour", activity: "braise" }],
      },
      {
        stepNumber: 3,
        title: "Add vegetables",
        text: "Add potatoes and onions. Continue cooking 30 minutes until potatoes are tender and beef is falling apart.",
        timers: [{ duration: "30 min", activity: "cook" }],
      },
      {
        stepNumber: 4,
        title: "Season and serve",
        text: "Stir in fish sauce, palm sugar, tamarind paste, and peanuts. Taste and adjust. Serve with jasmine rice.",
      },
    ],
  },
